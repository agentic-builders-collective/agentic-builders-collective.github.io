...
- For members, set `addedAt` to an ISO 8601 UTC timestamp; the Community page sorts members by that value, oldest first. This keeps the list first-come, first-shown for now, and repository admins may adjust it based on PR timing or review history.
